...
# x = order_document_sections_by_query_similarity("Who is Anita Reuben?", document_embeddings)[:5]




results = answer_query_with_context("Who wrote the E.A.T. newsletter?", df, document_embeddings)
#Where did Juilie Martin go to school?
#What was the structure of the E.A.T. organization?
#Who was Billy Kluver?
docs = []
